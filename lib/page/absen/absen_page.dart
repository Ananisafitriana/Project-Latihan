...
import 'package:jujur_ajalah/page/absen/camera_page.dart';
import 'package:jujur_ajalah/page/main_page.dart';
...
class _AbsenPageState extends State<AbsenPage> {
  ...
  final CollectionReference dataCollection =
      FirebaseFirestore.instance.collection('coba-lagii');
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        elevation: 0,
        backgroundColor: Color.fromARGB(255, 99, 211, 255),
        leading: IconButton(
              ...
              children: [
                Container(
                  ...
                  decoration: const BoxDecoration(
                    ...
                    color: Color.fromARGB(255, 99, 211, 255),
                  ),
                  child: const Row(
                    children: [
                      SizedBox(
